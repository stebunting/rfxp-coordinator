...
class CoordinationTests {
    ...
    class CoordinationMethodTests {
        ...
        final void testGetChannelArray() throws InvalidFrequencyException {
            ...
            assertEquals(420425, channelArray[0].getFreq());
            assertEquals(600000, channelArray[1].getFreq());
            assertEquals(760525, channelArray[2].getFreq());
        }
    }
    ...
    class CoordinationStressTests {
        ...
        final void testStress() throws InvalidFrequencyException {
            ...
            for (int i = 0; i < numTests; i++) {
                ...
                assertEquals(TestHelpers.expectedIntermods(coordination), coordination.getNumIntermods());
            }
